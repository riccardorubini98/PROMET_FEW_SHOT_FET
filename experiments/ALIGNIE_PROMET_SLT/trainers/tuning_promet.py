...
from entity_typing_framework.main_module.main_module import ALIGNIEMainModule, CrossDatasetMainModule, IncrementalMainModule, PROMETMainModule
...
cli = MyLightningCLI(PROMETMainModule, DatasetManager, save_config_overwrite=True)
# load best model
...
# test step
cli.trainer.test(cli.trainer.model, cli.trainer.datamodule.val_dataloader())
